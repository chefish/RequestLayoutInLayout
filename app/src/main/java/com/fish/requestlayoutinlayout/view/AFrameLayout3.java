...
public class AFrameLayout3 extends FrameLayout {
    public AFrameLayout3(@NonNull Context context) {
        super(context);
    }

    public AFrameLayout3(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AFrameLayout3(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
